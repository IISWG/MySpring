...
import cn.muxin.springframework.aop.framework.adapter.MethodBeforeAdviceInterceptor;
...
import test.bean.UserServiceBeforeAdvice;
...
public class ApiTest {
    ...
    public void test_advisor() {
        ...
        advisor.setExpression("execution(* test.bean.IUserService.*(..))");
